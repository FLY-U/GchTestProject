...
public class SelectPhotoDialog extends Dialog implements View.OnClickListener {
    ...
    LinearLayout llOut;
    private GalleryFinal.OnHandlerResultCallback mcallback;
    private int requestCode;
    private int num; //可选照片的数量
    private Context context;

    public SelectPhotoDialog(int num, Context context, int requestCode, GalleryFinal.OnHandlerResultCallback callback) {
        super(context);
